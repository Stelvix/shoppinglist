...
public class SecurityConfig {
        ...
        public SecurityFilterChain securityFilterChain(HttpSecurity http,
                ...
                return http
                                ...
                                .authorizeHttpRequests(auth -> auth
                                                .requestMatchers("/api/auth/**").permitAll() // Toutes les routes qui
                                                                                             // commencent par
                                                                                             // /api/auth/
                                                ...
                                                .anyRequest().authenticated() // TOUTES les autres routes nécessitent
                                                                              // d'être connecté
                                )
        ...
        public CorsConfigurationSource corsConfigurationSource(
                ...
                // On découpe la chaîne par les virgules pour recréer proprement la liste
                List<String> allowedOrigins = Arrays.stream(allowedOriginsStr.split(","))
                                .map(String::trim)
                                .toList();

                // Sécurité obligatoire pour les navigateurs :
                // Si la liste contient "*", on ne peut pas mettre "allowCredentials(true)"
