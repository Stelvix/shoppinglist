...
export function Brand() {
  return (
    <div className="flex items-center gap-3">
      <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-primary text-white shadow-sm shadow-blue-200">
        <AiOutlineShoppingCart className="h-5 w-5" />
      </span>
      <span className="font-black text-textPrimary">Shopping List</span>
    </div>
  )
}
